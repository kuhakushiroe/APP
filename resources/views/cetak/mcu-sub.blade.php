...
<body>
    @php
        $query = DB::table('mcu')
            ...
            ->where('mcu.id', $id)
            ->first();
        $carifollowup = DB::table('follow_up_multi')->where('id_mcu', $id)->where('id_mcu', $id)->get();
    @endphp
    @forelse ($carifollowup as $datafollowup)
        ...
        <div class="isi">
            ...
            <table style="width:100%;">
                <tr>
                    <td colspan="4" style="text-align: left;">Yang bertanda tangan di bawah ini menerangkan bahwa :
                    </td>
                </tr>
                <tr style="">
                ...
                <tr style="">
                    ...
                    <td style="width: 1px;">:</td>
                    <td>{{ \Carbon\Carbon::parse($query->tgl_verifikasi ?? '')->locale('id')->isoFormat('D MMMM Y') }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3" style="text-align: left;">
                        {{ $datafollowup->keterangan_followup }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <table style="width: 100%;text-align: center;">
                            ...
                            <tr>
                                <td style="width: 40%;">&nbsp;</td>
                                <td style="text-align: center;">
                                    <img src="{{ public_path('storage/' . $query->verifikator . '.jpg') }}"
                                        alt="" width="150px">
                                </td>
                            </tr>
                            {{-- <tr>
