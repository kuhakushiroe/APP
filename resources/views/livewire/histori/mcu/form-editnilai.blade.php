    ...
    <div class="row pt-2">
        <div class="col-md-12">
            ...
            <div class="card card-primary card-outline mb-4">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="storenilai" class="g-3 row">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="BB" placeholder="BB">
                                    @error('BB')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="TB" placeholder="TB">
                                    @error('TB')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="LP" placeholder="LP">
                                    @error('LP')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="Laseq" placeholder="Laseq">
                                    @error('Laseq')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <select type="text"
                                        ...
                                        wire:model.live="reqtal_touche" placeholder="Reqtal Touche">
                            ...
                            <div class="card-body row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="number"
                                        ...
                                        wire:model.live="sistol" placeholder="Sistol">
                                    @error('sistol')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number"
                                        ...
                                        wire:model.live="diastol" placeholder="Diastol">
                                    @error('diastol')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="OD_jauh" placeholder="OD Jauh">
                                    @error('OD_jauh')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="OS_jauh" placeholder="OS Jauh">
                                    @error('OS_jauh')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="OD_dekat" placeholder="OD Dekat">
                                    @error('OD_dekat')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="OS_dekat" placeholder="OS Dekat">
                                    @error('OS_dekat')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-12">
                                    ...
                                    <select
                                        ...
                                        wire:model.live="butawarna" placeholder="Buta Warna">
                            ...
                            <div class="card-body row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="gdp" placeholder="GDP">
                                    @error('gdp')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="gd_2_jpp" placeholder="GD 2 JPP">
                                    @error('gd_2_jpp')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="ureum" placeholder="Ureum">
                                    @error('ureum')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="creatine" placeholder="Creatine">
                                    @error('creatine')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="asamurat" placeholder="Asam Urat">
                                    @error('asamurat')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="sgot" placeholder="SGOT">
                                    @error('sgot')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="sgpt" placeholder="SGPT">
                                    @error('sgpt')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-12">
                                    ...
                                    <input type="number"
                                        ...
                                        wire:model.live="anti_hbs" placeholder="Anti HBs">
                                    @error('anti_hbs')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-sm-3">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="kolesterol" placeholder="Kolesterol">
                                    @error('kolesterol')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="hdl" placeholder="HDL">
                                    @error('hdl')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="ldl" placeholder="LDL">
                                    @error('ldl')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        wire:model.live="tg" placeholder="TG">
                                    @error('tg')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="darah_rutin" placeholder="Darah Rutin">
                                    @error('darah_rutin')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select
                                        ...
                                        wire:model.live="napza" placeholder="NAPZA">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="urin" placeholder="Urin">
                                    @error('urin')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="ekg" placeholder="EKG">
                                    @error('ekg')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="rontgen" placeholder="Rontgen">
                                    @error('rontgen')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="audiometri" placeholder="Audiometri">
                                    @error('audiometri')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="spirometri" placeholder="Spirometri">
                                    @error('spirometri')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select
                                        ...
                                        wire:model.live="tredmil_test" placeholder="Treadmill Test">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select
                                        ...
                                        wire:model.live="echocardiography" placeholder="Treadmill Test">
                                        <option value="">Pilih Hasil</option>
                                        <option value="Normal">Normal</option>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="widal_test" placeholder="Widal Test">
                                    @error('widal_test')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="routin_feces" placeholder="Routin Feces">
                                    @error('routin_feces')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model.live="kultur_feces" placeholder="Kultur Feces">
                                    @error('kultur_feces')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="card-body row">
                                <div class="col-sm-6">
                                    ...
                                    <select
                                        ...
                                        wire:model.live="kesadaran" placeholder="Kehilangan Kesadaran">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select
                                        ...
                                        wire:model.live="epilepsi" placeholder="Epilepsi">
                                        <option value="">Pilih Option</option>
                                        <option value="yes">yes</option>
                                        <option value="no">no</option>
                                    </select>
