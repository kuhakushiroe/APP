                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" @if ($status_karyawan === 'TEMPORARY') style="display: none;" @endif>
                            ...
                            @else
                                ...
                                @endif
                            @endif
                            <input type="hidden" class="form-control form-control-sm" wire:model="nrp_lama">
                            <input type="hidden" class="form-control form-control-sm" wire:model="nama_lama">
                            <input type="hidden" class="form-control form-control-sm" wire:model="jabatan_lama">
                            <input type="hidden" class="form-control form-control-sm" wire:model="departemen_lama">
                        ...
                        <div class="form-group">
                            <label for="doh">Tanggal Masuk</label>
                            <input type="date"
                                class="form-control form-control-sm @error('doh') is-invalid @enderror" wire:model="doh"
                        ...
                        @else
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    wire:model="dept" placeholder="dept" readonly>
                                @error('dept')
                                    <span class="invalid-feedback"
                                        role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm @error('jabatan') is-invalid @enderror"
                                ...
                                @foreach ($jabatans as $datajabatan)
                                    <option value="{{ $datajabatan->nama_jabatan }}">
