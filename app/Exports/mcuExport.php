...
class mcuExport implements FromQuery, WithHeadings, WithStyles, WithColumnFormatting
{
    ...
    public function __construct($date_mcu1 = null, $date_mcu2 = null)
    {
    ...
    public function query()
    {
        if (!$this->date_mcu1 || !$this->date_mcu2) {
            ...
            return ModelsMcu::join('karyawans', 'karyawans.nrp', '=', 'mcu.id_karyawan')
                ->whereBetween('mcu.tgl_verifikasi', [$this->date_mcu1, $this->date_mcu2])
                ->select(
                    'karyawans.nrp',
                    DB::raw("CONCAT('\'', karyawans.nik) as nik"),
                    'karyawans.nama',
